...
#ifndef header_button_style_Bitmap
#define header_button_style_Bitmap
...
class CL_Button_Bitmap : public CL_ComponentStyle
{
public:
    enum ButtonType {
        type_text,
...
public:
	CL_Button_Bitmap(
		CL_Button *button,
		CL_StyleManager_Bitmap *style, ButtonType btn_type = type_text,
            ButtonSize = size_normal);

	virtual ~CL_Button_Bitmap();
public:
