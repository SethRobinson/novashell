...
CL_Label_Bitmap::CL_Label_Bitmap(
	CL_Label * label,
    ...
    resources_(style->get_resources())
{
    ...
    slots_.connect(label_->sig_paint(), this, &CL_Label_Bitmap::on_paint);
    slots_.connect(label_->sig_get_preferred_size(), this, &CL_Label_Bitmap::on_get_preferred_size);
    slots_.connect(label_->sig_set_options(), this, &CL_Label_Bitmap::on_set_options);
}
...
void CL_Label_Bitmap::on_get_preferred_size(CL_Size &size)
{
    label_->set_height(font_->get_height("P"));
    label_->set_width(font_->get_width(label_->get_text()));
...
void CL_Label_Bitmap::on_set_options(const CL_DomElement &options)
{
